...
<script src="<?php echo base_url('assets/sbadmin/vendor/bootstrap/js/bootstrap.bundle.min.js'); ?>"></script>
  ...
  <script src="<?php echo base_url('assets/sbadmin/vendor/jquery-easing/jquery.easing.min.jss'); ?>"></script>
  ...
  <script src="<?php echo base_url('assets/sbadmin/vendor/js/demo/datatables-demo.js'); ?>"></script>
